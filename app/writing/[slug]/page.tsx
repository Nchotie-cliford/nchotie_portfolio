      ...
      <article className="container mx-auto px-6 pt-28 pb-24">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="prose prose-zinc max-w-none
            ...
            prose-code:text-primary prose-code:bg-background-secondary
            prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-xs prose-code:before:content-none prose-code:after:content-none
